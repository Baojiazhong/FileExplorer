        ...
        <div className={`file-icon file-icon-${iconType} ${sizeClasses[size] || ''}`}>
            ...
            {(extension === 'doc' || extension === 'docx') && (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <text x="12" y="16" textAnchor="middle" fontSize="6" fill="currentColor">W</text>
                </svg>
            )}
            ...
            {(extension === 'xls' || extension === 'xlsx') && (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                    <polyline points="14 2 14 8 20 8"></polyline>
                    <path d="M8 13h2l2 3 2-3h2"></path>
                    <path d="M8 17h8"></path>
                    <text x="12" y="16" textAnchor="middle" fontSize="6" fill="currentColor">X</text>
                </svg>
            )}
            ...
            {(extension === 'ppt' || extension === 'pptx') && (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <text x="12" y="16" textAnchor="middle" fontSize="6" fill="currentColor">P</text>
                </svg>
            )}

            {/* Text files */}
            {(iconType === 'text' || extension === 'txt' || extension === 'md') && (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                    <polyline points="14 2 14 8 20 8"></polyline>
                    <line x1="16" y1="13" x2="8" y2="13"></line>
            ...
            {/* Configuration files */}
            {(extension === 'json' || extension === 'xml' || extension === 'yaml' || extension === 'toml' || extension === 'ini') && (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
